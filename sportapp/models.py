...
class Tourney(models.Model):
    ...
    participants = models.IntegerField('Участники', default=10, null=True)
    ...
    judje_sum = models.DecimalField('Судейские', max_digits=15, decimal_places=2, default=0, null=True)
    reward_sum = models.DecimalField('Наградная', max_digits=15, decimal_places=2, default=0, null=True)
    print_sum = models.DecimalField('Печатная', max_digits=15, decimal_places=2, default=0, null=True)
    ...
    medic_sum = models.DecimalField('Медики', max_digits=15, decimal_places=2, default=0, null=True)
    ...
    cup1_sum = models.DecimalField('Сумма кубков за 1 место', max_digits=15, blank=True, null=True, decimal_places=2, default=0)
    cup1_kol = models.IntegerField('Кол-во кубков за 1 место', blank=True, null=True, default=0)
    cup2_sum = models.DecimalField('Сумма кубков за 2 место', max_digits=15, blank=True, null=True, decimal_places=2, default=0)
    cup2_kol = models.IntegerField('Кол-во кубков за 2 место', blank=True, null=True, default=0)
    cup3_sum = models.DecimalField('Сумма кубков за 3 место', max_digits=15, blank=True, null=True, decimal_places=2, default=0)
    cup3_kol = models.IntegerField('Кол-во кубков за 3 место', blank=True, null=True, default=0)
    cups_sum = models.DecimalField('Сумма кубков', max_digits=15, blank=True, null=True, decimal_places=2, default=0)
    cups_kol = models.IntegerField('Кол-во кубков', blank=True, null=True, default=0)
    tokens_sum = models.DecimalField('Сумма жетонов', max_digits=15, blank=True, null=True, decimal_places=2, default=0)
    tokens_kol = models.IntegerField('Кол-во жетонов', blank=True, null=True, default=0)
    medals_sum = models.DecimalField('Сумма медалей', max_digits=15, blank=True, null=True, decimal_places=2, default=0)
    medals_kol = models.IntegerField('Кол-во медалей', blank=True, null=True, default=0)
    prizes_sum = models.DecimalField('Сумма призов', max_digits=15, blank=True, null=True, decimal_places=2, default=0)
    prizes_kol = models.IntegerField('Кол-во призов', blank=True, null=True, default=0)
    diploms_sum = models.DecimalField('Сумма дипломов', max_digits=15, blank=True, null=True, decimal_places=2, default=0)
    diploms_kol = models.IntegerField('Кол-во дипломов', blank=True, null=True, default=0)
    postersA4_sum = models.DecimalField('Сумма афиш А4', max_digits=15, blank=True, null=True, decimal_places=2, default=0)
    postersA4_kol = models.IntegerField('Кол-во афиш А4', blank=True, null=True, default=0)
    postersA3_sum = models.DecimalField('Сумма афиш А3', max_digits=15, blank=True, null=True, decimal_places=2, default=0)
    postersA3_kol = models.IntegerField('Кол-во афиш А3', blank=True, null=True, default=0)
    postersA2_sum = models.DecimalField('Сумма афиш А2', max_digits=15, blank=True, null=True, decimal_places=2, default=0)
    postersA2_kol = models.IntegerField('Кол-во афиш А2', blank=True, null=True, default=0)
    banners_sum = models.DecimalField('Сумма баннеров', max_digits=15, blank=True, null=True, decimal_places=2, default=0)
    banners_kol = models.IntegerField('Кол-во баннеров',  blank=True, null=True, default=0)
    frames_sum = models.DecimalField('Сумма рамок', max_digits=15, blank=True, null=True, decimal_places=2, default=0)
    frames_kol = models.IntegerField('Кол-во рамок', blank=True, null=True, default=0)
    badges_sum = models.DecimalField('Сумма бейджей', max_digits=15, blank=True, null=True, decimal_places=2, default=0)
    badges_kol = models.IntegerField('Кол-во бейджей', blank=True, null=True, default=0)
    stickers_sum = models.DecimalField('Сумма наклеек', max_digits=15, blank=True, null=True, decimal_places=2, default=0)
    stickers_kol = models.IntegerField('Кол-во наклеек', blank=True, null=True, default=0)
    numbers_sum = models.DecimalField('Сумма номеров', max_digits=15, blank=True, null=True, decimal_places=2, default=0)
    numbers_kol = models.IntegerField('Кол-во номеров', blank=True, null=True, default=0)
    tablesA1_sum = models.DecimalField('Сумма таблиц А1', max_digits=15, blank=True, null=True, decimal_places=2, default=0)
    tablesA1_kol = models.IntegerField('Кол-во таблиц А1', blank=True, null=True, default=0)
    ambulance_time = models.DecimalField('Скорая помощь( часы )', max_digits=15, blank=True, null=True, decimal_places=2, default=0)
    ambulance_sum = models.DecimalField('Скорая помощь( сумма )', max_digits=15, blank=True, null=True, decimal_places=2, default=0)
